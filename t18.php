...
<div id="clue" ><pre>
  ...
  <form name="form1" method="post" action="t18.php">
    <input type="text" style="height:50px;width:200px;font-size:30px;" id="ans" /> <input type="button" style="height:50px;width:150px;font-size:30px;" value="Submit"/> <input type="button" style="height:50px;width:150px;font-size:30px;" value="back" onclick="change()"/>
 </pre>
  </div>
<audio id="au1">
