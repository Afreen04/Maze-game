...
<img id="white" src="whitewalker.jpg" width="1000px" height="560px">
<img id="whiteopen" src="whiteopen.jpg" width="1000px" height="560px">
<div>
...
var wohnd=document.getElementById("whiteopen");
...
function movemouth(){
console.log(mm);
if(whnd.style.display=="none"){
whnd.style.display="block";
wohnd.style.display="none";
}
else {
whnd.style.display="none";
wohnd.style.display="block";}
}
</script>
</body>
</html>
